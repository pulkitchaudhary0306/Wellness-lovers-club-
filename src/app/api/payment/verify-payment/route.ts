...
export async function POST(req: NextRequest) {
  ...
  // 1. Authoritative WordPress backend verification
  try {
    ...
    console.warn("WordPress verify-payment proxy failed, performing fallback signature verification:", wpErr);
  }
  ...
  return NextResponse.json({
    success: true,
    message: "Membership payment verified.",
